...
// Digital models A PiFace Digital board.
type Digital struct {
...
// NewDigital will Create a new Digital Instance
func NewDigital(hardware_addr byte, bus int, chip_select int) *Digital {
	pfd := new(Digital)
...
func (pfd *Digital) InitBoard() error {
...
// Not Implemented
func (pfd *Digital) EnableInterrupts() error {
	return fmt.Errorf("EnableInterrupts() Not implemented")
}

// Not Implemented
func (pfd *Digital) Open() error {
	return fmt.Errorf("Open() Not implemented")
}

// Not Implemented
func (pfd *Digital) Close() error {
